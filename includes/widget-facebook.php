...
class fb_likebox_widget extends WP_Widget {
	function fb_likebox_widget() {
		...
		$widget_ops = array('classname' => 'Like-box','description' => esc_html__('Facebook Like Box','moxietheme'));

		parent::__construct('Like-box',esc_html__('[Micro Themes] - Facebook Likebox','moxietheme'),$widget_ops);
...
function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_html__('Facebook','moxietheme'),
			//'fa_icon' => '',
		...
		<p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'minimize_header' )); ?>"><?php esc_html_e('Minimize header?', 'moxietheme'); ?></label>  
        </p>  
        ...
        <p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_faces' )); ?>"><?php esc_html_e('Display faces?', 'moxietheme'); ?></label>  
        </p> 
        ...
        <p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_cover' )); ?>"><?php esc_html_e('Display cover?', 'moxietheme'); ?></label>  
        </p> 
        ...
        <p>  
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_stream' )); ?>"><?php esc_html_e('Display stream?', 'moxietheme'); ?></label>  
        </p>  

    	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'height' )); ?>"><?php esc_html_e('Height:', 'moxietheme') ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'page' )); ?>"><?php esc_html_e('Facebook Page URL:', 'moxietheme') ?></label>
