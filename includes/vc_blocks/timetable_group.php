...
vc_map( array(
    ...
    "params" => array(
       ...
       array(
            ...
            "param_name" => "el_id",
            "description" => __("Assign a unique number value for this Time Table. If you are creating multiple Time Tables on a single page please make sure each Time Table menu has a unique number assigned to it in order to avoid conflicts between menus.", 'moxietheme'),
...
vc_map( array(
    "name" => __("Time Table Item", 'moxietheme'),
    ...
    "params" => array(
		...
		array(
            ...
            "param_name" => "el_icon",
            "description" => __("Enter a FontAwesome 4 value.", 'moxietheme'),
			"value" => 'fa fa-clock-o'
        ),
		...
		array(
            ...
            "param_name" => "content",
            "description" => __("Structure your content in an unordered list for proper formatting.", 'moxietheme')
        ),
