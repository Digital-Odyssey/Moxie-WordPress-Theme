    ...
    class WPBakeryShortCode_pm_ln_datatable_group extends WPBakeryShortCodesContainer {
		...
		protected function content($atts, $content = null) {
			...
			extract(shortcode_atts(array(
				'el_id' => '',
				'el_title_bg_color' => '#306173',
				'el_title_color' => '#ffffff',
				'el_content_bg_color' => '#e0e0e0',
				'el_content_color' => '#000000',
			), $atts));
...
vc_map( array(
    ...
    "params" => array(
		...
		array(
            "type" => "colorpicker",
            "heading" => __("Title Background Color", 'moxietheme'),
		...
		array(
            "type" => "colorpicker",
            "heading" => __("Title Color", 'moxietheme'),
		...
		array(
            "type" => "colorpicker",
            "heading" => __("Content Background Color", 'moxietheme'),
		...
		array(
            "type" => "colorpicker",
            "heading" => __("Content Color", 'moxietheme'),
...
vc_map( array(
    "name" => __("Data Table Item", 'moxietheme'),
