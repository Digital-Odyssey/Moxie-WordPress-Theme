...
vc_map( array(
    ...
    "params"    => array(
		...
		array(
            "type" => "textfield",
            "heading" => __("Author Name", 'moxietheme'),
		...
		array(
            "type" => "textfield",
            "heading" => __("Author Title", 'moxietheme'),
		...
		array(
            "type" => "colorpicker",
            "heading" => __("Name Color", 'moxietheme'),
