...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
    class WPBakeryShortCode_pm_ln_slider_carousel extends WPBakeryShortCodesContainer {
		...
		protected function content($atts, $content = null) {
			...
			echo '<div class="flexslider pm-carousel-slider" id="pm-flexslider-carousel-'.$GLOBALS['pm_ln_flexslider_count'].'" style="width:100%;"><ul class="slides">'.do_shortcode($content).'</ul></div>';
...
vc_map( array(
    "name" => __("Slider Carousel", 'moxietheme'),
    ...
    "params" => array(
       ...
       array(
            "type" => "dropdown",
            "heading" => __("Animation Type", 'moxietheme'),
            "param_name" => "el_animation",
            "description" => __("Choose between a slide or fade effect.", 'moxietheme'),
...
vc_map( array(
    ...
    "params" => array(
        ...
        array(
            "type" => "textfield",
            "heading" => __("Alt attribute", 'moxietheme'),
            "param_name" => "el_title",
            "description" => __("Enter a descriptive alt attribute - this is used for SEO purposes.", 'moxietheme'),
			"value" => ''
        ),
		...
		array(
            ...
            "param_name" => "el_image",
            "description" => __("Upload an image for your slide.", 'moxietheme')
        ),
