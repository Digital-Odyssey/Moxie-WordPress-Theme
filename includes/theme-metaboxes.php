...
add_action('do_meta_boxes', 'moxie_theme_render_new_post_thumbnail_meta_box');


/*** NEW FEATURED IMAGE FOR POSTS WITH DETAILS *****/
function moxie_theme_new_post_thumbnail_meta_box() {
	
    global $post; // we know what this does
     
    echo '<p>'. esc_html__('Recommended size: 1170x400px', 'moxietheme') .'</p>';
...
function moxie_theme_render_new_post_thumbnail_meta_box() {
    ...
    add_meta_box('postimagediv', esc_html__('Featured Image', 'moxietheme'), 'moxie_theme_new_post_thumbnail_meta_box', 'post', 'side', 'low');
...
function pm_header_image_meta_function($post) {
	...
	//HTML code
	?>
    	<p><?php esc_html_e('Recommended size: 1920x500px', 'moxietheme') ?></p>
		<input type="text" value="<?php echo esc_url(esc_html($pm_header_image_meta)); ?>" name="post-header-image" id="img-uploader-field" class="pm-admin-upload-field" />
		<input id="upload_image_button" type="button" value="<?php esc_html_e('Media Library Image', 'moxietheme'); ?>" class="button button-primary button-large" />
        <div class="pm-admin-upload-field-preview"></div>
        
        <?php if($pm_header_image_meta) : ?>
        	<input id="remove_page_header_button" type="button" value="<?php esc_html_e('Remove Image', 'moxietheme'); ?>" class="button button-primary button-large" />
        <?php endif; ?>        
...
function pm_post_layout_meta_function($post) {
	...
	?>
        <p><?php esc_html_e('Select your desired layout for this post.', 'moxietheme'); ?></p>
        <select id="pm_post_layout_meta" name="pm_post_layout_meta" class="pm-admin-select-list">  
            <option value="no-sidebar" <?php selected( $pm_post_layout_meta, 'no-sidebar' ); ?>><?php esc_html_e('No Sidebar', 'moxietheme') ?></option>
            <option value="left-sidebar" <?php selected( $pm_post_layout_meta, 'left-sidebar' ); ?>><?php esc_html_e('Left Sidebar', 'moxietheme') ?></option>
            <option value="right-sidebar" <?php selected( $pm_post_layout_meta, 'right-sidebar' ); ?>><?php esc_html_e('Right Sidebar', 'moxietheme') ?></option>
        </select>
...
function add_page_metaoptions() {
	...
	add_meta_box(
        'custom_sidebar',
        esc_html__( 'Custom Sidebar', 'moxietheme' ),
        'moxie_theme_custom_sidebar_callback',
        'page',
        'side'
    );
...
function moxie_theme_custom_sidebar_callback( $post ){
    ...
    $output = '<p><label for="myplugin_new_field">'.esc_html__("Choose a sidebar to display", 'moxietheme' ).'</label></p>';
    ...
    $output .= " value='default'>".esc_html__('No Sidebar', 'moxietheme')."</option>";
...
function pm_page_layout_meta_function($post) {
	...
	?>
        ...
        <select id="pm_page_layout_meta" name="pm_page_layout_meta" class="pm-admin-select-list">  
            <option value="no-sidebar" <?php selected( $pm_page_layout_meta, 'no-sidebar' ); ?>><?php esc_html_e('No Sidebar', 'moxietheme') ?></option>
            <option value="left-sidebar" <?php selected( $pm_page_layout_meta, 'left-sidebar' ); ?>><?php esc_html_e('Left Sidebar', 'moxietheme') ?></option>
            <option value="right-sidebar" <?php selected( $pm_page_layout_meta, 'right-sidebar' ); ?>><?php esc_html_e('Right Sidebar', 'moxietheme') ?></option>
        </select>
...
function pm_page_disable_container_meta_function($post) {
	...
	?>
        ...
        <select id="pm_page_disable_container_meta" name="pm_page_disable_container_meta" class="pm-admin-select-list"> 
        	<option value="no" <?php selected( $pm_page_disable_container_meta, 'no' ); ?>><?php esc_html_e('No', 'moxietheme') ?></option> 
            <option value="yes" <?php selected( $pm_page_disable_container_meta, 'yes' ); ?>><?php esc_html_e('Yes', 'moxietheme') ?></option>
        </select>
...
function pm_page_print_share_meta_function($post) {
	...
	?>
        ...
        <select id="pm_page_print_share_meta" name="pm_page_print_share_meta" class="pm-admin-select-list"> 
        	<option value="on" <?php selected( $pm_page_print_share_meta, 'on' ); ?>><?php esc_html_e('ON', 'moxietheme') ?></option> 
            <option value="off" <?php selected( $pm_page_print_share_meta, 'off' ); ?>><?php esc_html_e('OFF', 'moxietheme') ?></option>
        </select>
...
function pm_display_header_meta_function($post) {
	...
	?>
        ...
        <select id="pm_display_header_meta" name="pm_display_header_meta" class="pm-admin-select-list"> 
        	<option value="on" <?php selected( $pm_display_header_meta, 'on' ); ?>><?php esc_html_e('ON', 'moxietheme') ?></option> 
            <option value="off" <?php selected( $pm_display_header_meta, 'off' ); ?>><?php esc_html_e('OFF', 'moxietheme') ?></option>
        </select>
...
function pm_disable_share_feature_function($post) {
	...
	?>
        <select id="pm_disable_share_feature" name="pm_disable_share_feature" class="pm-admin-select-list">  
            <option value="no" <?php selected( $pm_disable_share_feature, 'no' ); ?>><?php esc_html_e('No', 'moxietheme') ?></option>
            <option value="yes" <?php selected( $pm_disable_share_feature, 'yes' ); ?>><?php esc_html_e('Yes', 'moxietheme') ?></option>
        </select>
